...
<head>
    ...
    <title>404 Page Not Found | <?php echo e(app_name()); ?></title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?php echo e(url('/')); ?>" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
...
</html><?php /**PATH C:\xampp\htdocs\absensi\resources\views/errors/404.blade.php ENDPATH**/ ?>