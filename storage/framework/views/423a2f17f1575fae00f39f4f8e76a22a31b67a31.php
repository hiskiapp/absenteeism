			...
			<form class="form-horizontal r-separator" method="POST" action="">
				...
				<div class="card-body">
					...
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<input autocomplete="off" required="" value="<?php echo e((empty($data) ? old('nis') : $data->getNis())); ?>" type="text" name="nis" class="form-control" id="nis" placeholder="11700599">
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						<label for="name" class="col-3 text-right control-label col-form-label">Nama</label> 
						<div class="col-9 border-left p-b-10 p-t-10">
							<input autocomplete="off" required="" value="<?php echo e((empty($data) ? old('name') : $data->getName())); ?>" type="text" name="name" class="form-control" id="name" placeholder="Hiskia Anggi">
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<select required="" class="select2 form-control" style="width: 100%; height:36px;" name="rombel_id" id="rombel_id">
								...
								<option <?php echo e(empty($data) ? '' : ($data->getRombelsId()->getId() == $row->id ? 'selected' : '')); ?> value="<?php echo e($row->id); ?>"><?php echo e($row->name); ?></option>
					...
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<select required="" class="select2 form-control" style="width: 100%; height:36px;" name="rayons_id" id="rayons_id">
								...
								<option <?php echo e(empty($data) ? '' : ($data->getRayonsId()->getId() == $row->id ? 'selected' : '')); ?> value="<?php echo e($row->id); ?>"><?php echo e($row->name); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<select required="" class="form-control" name="gender" id="gender">
								...
								<option <?php echo e(empty($data) ? '' : ($data->getGender() == 'Laki - Laki' ? 'selected' : '')); ?> value="Laki - Laki">Laki - Laki</option>
								<option <?php echo e(empty($data) ? '' : ($data->getGender() == 'Perempuan' ? 'selected' : '')); ?> value="Perempuan">Perempuan</option>
							</select>
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<div id="birth_city">
								<input required="" value="<?php echo e((empty($data) ? old('birth_city') : $data->getBirthCity())); ?>" autocomplete="off" type="text" name="birth_city" class="typeahead form-control" placeholder="Kota Lahir">
							</div>
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<input autocomplete="off" required="" value="<?php echo e((empty($data) ? old('birth_city') : datePicker($data->getBirthDate()))); ?>" type="text" name="birth_date" class="form-control mydatepicker" placeholder="dd-mm-yyyy">
						</div>
					</div>
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<select required="" class="form-control" name="religion" id="religion">
								...
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Islam' ? 'selected' : '')); ?> value="Islam">Islam</option>
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Kristen' ? 'selected' : '')); ?> value="Kristen">Kristen</option>
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Buddha' ? 'selected' : '')); ?> value="Buddha">Buddha</option>
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Katolik' ? 'selected' : '')); ?> value="Katolik">Katolik</option>
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Hindu' ? 'selected' : '')); ?> value="Hindu">Hindu</option>
								<option <?php echo e(empty($data) ? '' : ($data->getReligion() == 'Konghucu' ? 'selected' : '')); ?> value="Konghucu">Konghucu</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="form-group row align-items-center m-b-0">
						...
						<div class="col-9 border-left p-b-10 p-t-10">
							<input autocomplete="off" value="<?php echo e((empty($data) ? old('name_of_guardian') : $data->getNameOfGuardian())); ?>" required="" type="text" name="name_of_guardian" class="form-control" id="name_of_guardian" placeholder="Tulis Disini..">
						</div>
					</div>
				</div>
				<div class="card-body">
...
<script src="<?php echo e(asset('assets/libs/typeahead.js/dist/typeahead.jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/typeahead.js/dist/bloodhound.min.js')); ?>"></script>
...
var birth_city = ["<?php echo $birth_city; ?>"];;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\absensi\resources\views/students/form.blade.php ENDPATH**/ ?>