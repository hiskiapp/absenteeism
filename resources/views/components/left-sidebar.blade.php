<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <li class="sidebar-item {{ (request()->segment(1) == 'employees' ? 'selected' : '')}}">
            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('employees') }}
            " aria-expanded="false">
    ...
    <li class="sidebar-item {{ (request()->segment(2) == 'students-list' || request()->segment(1) == 'students-calendar' ? 'selected' : '')}}">
        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
    ...
    <li class="sidebar-item {{ (request()->segment(2) == 'teachers-list' || request()->segment(1) == 'teachers-calendar' ? 'selected' : '')}}">
        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
